            ...
            <div className="w-full px-4">
              <div className="hero-content  mx-auto max-w-[780px] text-center">
                ...
                <ul className="mb-10  flex flex-wrap items-center justify-center gap-5">
                  <li>
                    <a className="inline-flex items-center justify-center rounded-md bg-white px-7 py-[14px] text-center text-base font-medium text-dark shadow-1 transition duration-300 ease-in-out hover:bg-gray-2 hover:text-body-color"> Book Now</a>
                  </li>
                  <li>
                    <Button variant="secondary" classes="px-7 py-[14px]">
                      Contact Us
                    </Button>
                  </li>
                </ul>
